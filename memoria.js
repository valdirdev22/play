...
const imagens = ['./IMAGENS_PEDRINHO/pedro-foto-1.jpg', './IMAGENS_PEDRINHO/pedro-foto-2.jpg', 
'./IMAGENS_PEDRINHO/pedro-foto-3.jpg', './IMAGENS_PEDRINHO/pedro-foto-5.jpg', './IMAGENS_PEDRINHO/pedro-foto-6.jpg', 
'./IMAGENS_PEDRINHO/pedro-foto-7.jpg'];
 
for (let i = 1; i <= 8; i++) imagens.push(`../JOGO_MEMORIA_JOSE/id/${i}/100`);
 
let fundo = `./IMAGENS_PEDRINHO/pedro-capa-1.jpg`;
...
onload = () => {
    ...
    document.body.style.backgroundImage = "url('./IMAGENS_PEDRINHO/pedro-back-aviao-1.jpg')";
};
...
const inicioJogo = () => {
  ...
  // Reinicia o estado do jogos
    ...
    document.body.style.backgroundImage = "url('./IMAGENS_PEDRINHO/pedro-back-aviao-2.jpg')";
...
temCartaVirada = false;
 ...
 if(pontos == 6) {
    ...
    document.querySelector('.titulo').textContent ='Parabéns Pedrinho!';
    document.querySelector('.titulo').style.backgroundColor ='#0101DF';  
    document.querySelector('#matematica').style.backgroundColor = '#0101DF';   
    document.body.style.backgroundImage = "url('./IMAGENS_PEDRINHO/pedro-back-helicoptero-1.jpg')";
    timerDoJogo.stop(); 
}     
